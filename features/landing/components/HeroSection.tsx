...
export function HeroSection() {
  return (
    <section className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-xl rounded-3xl p-4 md:p-8 mb-16 shadow-lg border border-white/50 dark:border-white/10 relative overflow-hidden flex flex-col lg:flex-row items-center gap-8">
